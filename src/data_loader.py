...
class DataLoader:
    ...
    def load_pcg_signal(self, sample_rate=None, start=0, end=None):
        ...
        # --- resampling PCG do fs_ecg:
        # zakładamy, że później w main: loader.load_ecg_signal() ustawi `fs_ecg`
        # więc tutaj w DataLoader nie znamy jeszcze fs_ecg.
        # Lepsze: przenieś resampling do main, zaraz po wczytaniu obu sygnałów!
